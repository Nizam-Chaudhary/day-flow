...
--> statement-breakpoint
CREATE UNIQUE INDEX `calendar_events_provider_connection_calendar_external_idx` ON `calendar_events` (`provider`,`connection_id`,`calendar_id`,`external_event_id`);--> statement-breakpoint
CREATE INDEX `calendar_events_calendar_idx` ON `calendar_events` (`calendar_id`);--> statement-breakpoint
CREATE TABLE `integration_calendars` (
	...
	`calendar_color_type` text DEFAULT 'curated' NOT NULL,
	`color_override` text,
	`last_sync_at` text,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `integration_calendars_connection_external_idx` ON `integration_calendars` (`connection_id`,`external_calendar_id`);--> statement-breakpoint
CREATE INDEX `integration_calendars_connection_idx` ON `integration_calendars` (`connection_id`);--> statement-breakpoint
