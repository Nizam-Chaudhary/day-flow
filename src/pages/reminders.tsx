    ...
    return (
        <section className='flex flex-col gap-6'>
            <div className='flex max-w-3xl flex-col gap-2'>
                <p className='text-sm text-muted-foreground'>Follow-up lane</p>
                        ...
                        {mockReminders
                            ...
                            .map((reminder) => {
                                ...
                                return (
                                    <div
                                        key={reminder.id}
                                        className='flex flex-col gap-3 rounded-2xl border bg-background p-4 lg:flex-row lg:items-center lg:justify-between'>
